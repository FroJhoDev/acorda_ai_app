...
/// Implementação simplificada do repositório de alarmes usando memória
class MemoryAlarmRepositoryImpl implements AlarmRepository {
  final MemoryAlarmDataSource _dataSource;

  MemoryAlarmRepositoryImpl(this._dataSource);
